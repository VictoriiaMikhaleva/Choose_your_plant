/**
 * Нормализует доп. JPG и добавляет карточки в RAW_PLANTS (id 101–107).
 * Для качественных WebP из Fitodesigner используйте sync из public/plants.
 *
...
const EXTRA = [
  ...
  {
    file: "Molochai_106.png",
    id: 106,
    nameRu: "Молочай беложилковый",
    nameLat: "Euphorbia leuconeura",
    family: "Молочайные",
    category: "Суккуленты, Декоративно-лиственное",
    origin: "Мадагаскар",
    temp: "18–26",
    light: "3000-8000",
    humidity: "40–60",
    ...
    petDanger: "Да",
    comments:
      "Суккулент с пальмообразной кроной и крупными листьями с выраженными белыми жилками. Любит яркий рассеянный свет и умеренный полив после подсыхания верхнего слоя грунта.",
  },
  {
    file: "marniera_107.png",
    id: 107,
    nameRu: "Марниера",
    nameLat: "Epiphyllum chrysocardium",
    family: "Кактусовые",
    category: "Суккуленты, Лианы, Цветущие",
    origin: "Мексика",
    temp: "18–26",
    light: "3000-8000",
    humidity: "50–70",
    watering: "на 1/2 горшка",
    soil: "Для эпифитов и полуэпифитов",
    ph: "5.5–6.0",
    petDanger: "Да",
    comments:
      "Эпифитный кактус с плоскими рассечёнными побегами. Не переносит полной пересушки субстрата; лучше в подвесном кашпо при высокой влажности.",
  },
];
